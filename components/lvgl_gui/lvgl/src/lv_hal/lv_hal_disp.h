...
uint8_t del_prev  :
    1;        /**< 1: Automatically del the previous screen when the screen load animation is ready */
...
/**
 * Pop (del) the last 'num' invalidated areas from the buffer
 * @param num number of areas to del
 */
